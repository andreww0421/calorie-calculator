export const homeUiCopyCatalog = {
    en: {
        ...
        heroSummaryBase: 'Quick logging, dining-out presets, and daily rhythm all stay close at hand.',
        heroSummaryRegion: (regionLabel, presetCount) => `${regionLabel} presets are ready for quick dining-out logs${presetCount > 0 ? ` (${presetCount})` : ''}.`,
        heroSummaryPreset: (regionLabel, presetName) => `${regionLabel} presets are ready. Try ${presetName} when you want a faster dining-out entry.`,
        ...
        quickLogCopyEmpty: 'Use dining-out presets, AI, or a fast manual entry to get the day moving.',
        quickLogCopyActive: 'Add the next meal fast, then keep the rest of the day easy to review.',
    ...
    'zh-TW': {
        ...
        heroSummaryBase: '\u5feb\u901f\u8a18\u9304\u3001\u5916\u98df preset \u8207\u7bc0\u594f\u63d0\u793a\u90fd\u6703\u5728\u9019\u88e1\u966a\u4f60\u4e00\u8d77\u8dd1\u3002',
        heroSummaryRegion: (regionLabel, presetCount) => `${regionLabel} \u7684\u5916\u98df preset \u5df2\u7d93\u6e96\u5099\u597d${presetCount > 0 ? ` (${presetCount})` : ''}\u3002`,
        heroSummaryPreset: (regionLabel, presetName) => `${regionLabel} \u7684 preset \u5df2\u7d93\u6e96\u5099\u597d\uff0c\u60f3\u8981\u5feb\u901f\u8a18\u9304\u6642\u53ef\u4ee5\u5148\u5f9e ${presetName} \u958b\u59cb\u3002`,
        heroSummaryActive: '\u4e0b\u4e00\u7b46\u7e7c\u7e8c\u8f15\u5feb\u8a18\u4e0b\uff0c\u4eca\u5929\u7684\u7bc0\u594f\u5c31\u6703\u66f4\u5bb9\u6613\u7dad\u6301\u3002',
        quickLogEyebrow: '\u5feb\u901f\u8a18\u4e0b',
        quickLogCopyEmpty: '\u53ef\u4ee5\u5148\u7528\u5916\u98df preset\u3001AI \u6216\u624b\u52d5\u8f38\u5165\u5e6b\u4eca\u5929\u958b\u500b\u982d\u3002',
        quickLogCopyActive: '\u5feb\u901f\u8a18\u4e0b\u4e0b\u4e00\u9910\uff0c\u5f8c\u9762\u7684\u98f2\u98df\u7bc0\u594f\u5c31\u6703\u66f4\u597d\u8ddf\u3002',
        mealListTitle: '\u4eca\u5929\u7684\u9910\u6b21',
